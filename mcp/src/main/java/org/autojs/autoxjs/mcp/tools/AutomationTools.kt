...
private fun captureImage(runtime: ScriptRuntimeV2): ImageWrapper {
    ...
    // Adaptation: in this codebase ScriptRuntime#images is private and exposed via getImages()
    // returning Object, so we must go through the getter and cast.
    @Suppress("UNCHECKED_CAST")
    val images = runtime.getImages() as Images
